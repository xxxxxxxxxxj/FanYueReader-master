...
import com.jack.reader.bean.BookRead;
...
import com.jack.reader.bean.PostCount;
...
import com.jack.reader.bean.user.Following;
...
public interface BookApiService {
    ...
    @POST(AppUtils.BASE_URL + "/web/index/api/updatauserinfo")
    Observable<DefaultBean> updatauserinfo(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/ad/api/index")
    Observable<BannerBean> getBannerList(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/index/api/pagehome")
    Observable<PageHomeBean> pagehome(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/type/api/index")
    Observable<ClassIndexBean> classIndex(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/hot/api/index")
    Observable<RankListBean> rankList(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/my/api/index")
    Observable<MyIndexBean> myIndex(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/type/api/booklist")
    Observable<NewBookListBean> bookListClass(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/hot/api/booklist")
    Observable<NewBookListBean> bookListBangDan(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/search/api/search")
    Observable<NewBookListBean> bookListSerch(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/my/api/booklist")
    Observable<NewBookListBean> bookListCollect(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/search/api/keyword")
    Observable<KeywordListBean> keyword(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/download/api/chapterlist")
    Observable<ChapterBean> getBookMixAToc(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/download/api/chapterinfo")
    Observable<ChapterInfoBean> getChapterRead(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/my/api/updatamybook")
    Observable<DefaultBean> updatamybook(@Body() RequestBody body);

    @POST(AppUtils.BASE_URL + "/web/tools/api/countread")
    Observable<DefaultBean> countread(@Body() RequestBody body);
}