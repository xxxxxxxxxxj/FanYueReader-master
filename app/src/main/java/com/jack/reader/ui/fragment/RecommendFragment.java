...
import com.jack.reader.bean.support.RefreshCollectionListEvent;
import com.jack.reader.bean.support.UserSexChooseFinishedEvent;
...
import com.jack.reader.ui.activity.MainActivity;
import com.jack.reader.ui.activity.ReadActivity;
import com.jack.reader.ui.contract.RecommendContract;
import com.jack.reader.ui.easyadapter.RecommendAdapter;
import com.jack.reader.ui.presenter.RecommendPresenter;
...
public class RecommendFragment extends BaseRVFragment<RecommendPresenter, Recommend.RecommendBooks> implements RecommendContract.View, RecyclerArrayAdapter.OnItemLongClickListener {
    ...
    public void showBookToc(String bookId, List<BookMixAToc.mixToc.Chapters> list) {
        ...
        DownloadBookService.post(new DownloadQueue(bookId, list, 1, list.size(),0,0));
        dismissDialog();
    }
