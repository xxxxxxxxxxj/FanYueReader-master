...
public class BookrackFragment extends BaseRVFragment<BookrackPresenter, PageHomeBean.PageHomeData.PageHomeBooks> implements BookrackContract.View, AMapLocationListener {
    ...
    public void configViews() {
        setLocation();
        initAdapter(BookrackAdapter.class, true, false);
