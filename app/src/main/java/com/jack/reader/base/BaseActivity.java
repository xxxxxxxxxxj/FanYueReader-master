...
import com.jack.reader.utils.SharedPreferenceUtil;
import com.jack.reader.utils.SharedPreferencesUtil;
import com.jack.reader.utils.StatusBarCompat;
import com.jack.reader.view.loadding.CustomDialog;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("BaseActivity","========statusBarColor=="+statusBarColor);
        if (statusBarColor == 0) {
            statusBarView = StatusBarCompat.compat(this, ContextCompat.getColor(this, R.color.colorPrimaryDark));
        } else {
            statusBarView = StatusBarCompat.compat(this, ContextCompat.getColor(this, R.color.white));
        }
        transparent19and20();
        mContext = this;
