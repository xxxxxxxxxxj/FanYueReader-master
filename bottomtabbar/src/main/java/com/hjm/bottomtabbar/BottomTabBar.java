...
public class BottomTabBar extends LinearLayout {
    ...
    //分割线背景
    private int dividerBackgroundColor = Color.parseColor("#B2B2B2");
    //BottomTabBar的整体背景
    ...
    public BottomTabBar(Context context, AttributeSet attrs) {
        ...
        if (attributes != null) {
            ...
            //分割线背景
            dividerBackgroundColor = attributes.getColor(R.styleable.BottomTabBar_tab_divider_background, Color.parseColor("#B2B2B2"));
